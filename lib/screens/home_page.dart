...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    _opacity = _scrollPosition < screenSize.height * 0.40 // tính năng cuộc thanh menu
        ? _scrollPosition / (screenSize.height * 0.40)
        : 1;
      debugPrint(_opacity.toString());
    return Scaffold(
      extendBodyBehindAppBar: true, // beautifull task bar
      appBar: PreferredSize( // kích thước ưa chuộng
        preferredSize: Size(screenSize.width, 70), //rong
        child: TopBarContents(_opacity), // cao
      ),
